 ...
 */
public class AnimationSides extends ViewAnimationProperty
{
     ...
     * @return
     */
    public static AnimationSides create(@Direction int direction, boolean enter, long duration) {
        switch (direction) {
            case UP:
            case DOWN:
    ...
    private AnimationSides(@Direction int direction, boolean enter, long duration) {
    ...
    private static class VerticalCubeAnimation extends AnimationSides {
    ...
    private static class HorizontalCubeAnimation extends AnimationSides {
