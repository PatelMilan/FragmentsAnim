 ...
 */
public class AnimationFlip extends ViewAnimationProperty {
     ...
     * @return
     */
    public static AnimationFlip create(@Direction int direction, boolean enter, long duration) {
        switch (direction) {
            case UP:
            case DOWN:
    ...
    private AnimationFlip(@Direction int direction, boolean enter, long duration) {
        mDirection = direction;
        mEnter = enter;
        setDuration(duration);
    }

    private static class VerticalFlipAnimation extends AnimationFlip {
    ...
    private static class HorizontalFlipAnimation extends AnimationFlip {
