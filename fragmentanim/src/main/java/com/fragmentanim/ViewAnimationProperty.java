...
/**
 * Created by Patel Milan on 6/6/16.
 */

public class ViewAnimationProperty extends Animation
{
    ...
    public ViewAnimationProperty fading(@FloatRange(from=0.0f,to=1.0f) float fromAlpha, @FloatRange(from=0.0f,to=1.0f) float toAlpha) {
